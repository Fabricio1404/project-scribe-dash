...
export const Route = createFileRoute("/presupuesto")({
  head: () => ({
    meta: [
      { title: "Presupuesto — CIT Nexus" },
      {
        name: "description",
        content: "Seguimiento presupuestario del CIT Formosa por proyecto, rubro y categoría, con nivel de ejecución.",
      },
      { property: "og:title", content: "Presupuesto — CIT Nexus" },
      { property: "og:description", content: "Ejecución presupuestaria por proyecto y rubro en el CIT Formosa." },
...
function PresupuestoPage() {
  const porRubro = new Map<string, { asignado: number; ejecutado: number; categoria: string }>();

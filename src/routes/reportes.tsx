...
export const Route = createFileRoute("/reportes")({
  head: () => ({
    meta: [
      { title: "Reportes institucionales — CIT Nexus" },
      {
        name: "description",
        content: "Indicadores consolidados del CIT Formosa: producción científica, diagnósticos, transferencias y ejecución.",
      },
      { property: "og:title", content: "Reportes institucionales — CIT Nexus" },
      { property: "og:description", content: "Memoria anual e indicadores de gestión científico-tecnológica del CIT Formosa." },
  ...
  return (
    <AppShell>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Proyectos" value={proyectos.length} detail={`${lineas.length} líneas de investigación`} />
              ...
              return (
                <div key={d.mes} className="flex flex-1 flex-col items-center gap-2">
                  <div
                    ...
                    title={`${total} análisis · ${d.positivos} positivos`}
                  >
      ...
      <div className="mt-6">
        ...
        <DataTable head={["Línea", "Proyectos", "Publicaciones", "Transferencias", "Estado"]}>
          {lineas.map((l) => {
